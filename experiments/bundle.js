...
(function () {
    ...
    */
    ...
    var ethers_min = createCommonjsModule(function (module, exports) {
        ! function (e) {
            ...
            return function n(i, o, s) {
                ...
                for (var u = "function" == typeof commonjsRequire && commonjsRequire, e = 0; e < s.length; e++) {
                    a(s[e]);
                }
                return a
            }({
                ...
                4: [function (e, t, r) {
                            ...
                            return ["data", "to"].forEach(function (e) {
                                ...
                                function n(i, o, e) {
                                    ...
                                    if (i.data = a.encode(n), "call" === a.type) {
                                        return s ? Promise.resolve(u.Zero) : (o.provider || l.throwError("call (constant functions) require a provider or a signer with a provider", l.UNSUPPORTED_OPERATION, {
                                            operation: "call"
                                    ...
                                    if ("transaction" === a.type) {
                                        return s ? (o.provider || l.throwError("estimate gas require a provider or a signer with a provider", l.UNSUPPORTED_OPERATION, {
                    ...
                    function A(t, e, r) {
                        ...
                        if (l.checkNew(this, A), d.Interface.isInterface(e) ? p.defineReadOnly(this, "interface", e) : p.defineReadOnly(this, "interface", new d.Interface(e)), m.Signer.isSigner(r) ? (p.defineReadOnly(this, "provider", r.provider), p.defineReadOnly(this, "signer", r)) : y.Provider.isProvider(r) ? (p.defineReadOnly(this, "provider", r), p.defineReadOnly(this, "signer", null)) : l.throwError("invalid signer or provider", l.INVALID_ARGUMENT, {
                            ...
                            }), this._events = [], p.defineReadOnly(this, "address", t), this.provider) {
                            p.defineReadOnly(this, "addressPromise", this.provider.resolveName(t).then(function (e) {
                                if (null == e) {
                    ...
                    ! function (e) {
                        ...
                        k.prototype._prepare = function () {
                            ...
                            for (var r, n = 4 * (e + 1), i = this.key.length / 4, o = S(this.key), t = 0; t < i; t++) {
                                this._Ke[r = t >> 2][t % 4] = o[t], this._Kd[e - r][t % 4] = o[t];
                            }
                            for (var s, a = 0, u = i; u < n;) {
                                ...
                                for (t = 0; t < i && u < n;) {
                                    this._Ke[l = u >> 2][h = u % 4] = o[t], this._Kd[e - l][h] = o[t++], u++;
                                }
                            }
                            for (var l = 1; l < e; l++) {
                                for (var h = 0; h < 4; h++) {
                            ...
                            for (var o = 1; o < t; o++) {
                                for (i = 0; i < 4; i++) {
                                    r[i] = h[n[i] >> 24 & 255] ^ p[n[(i + 1) % 4] >> 16 & 255] ^ y[n[(i + 2) % 4] >> 8 & 255] ^ m[255 & n[(i + 3) % 4]] ^ this._Ke[o][i];
                                }
                                n = r.slice();
                            }
                            ...
                            for (var o = 1; o < t; o++) {
                                for (i = 0; i < 4; i++) {
                                    r[i] = g[n[i] >> 24 & 255] ^ v[n[(i + 3) % 4] >> 16 & 255] ^ b[n[(i + 2) % 4] >> 8 & 255] ^ w[255 & n[(i + 1) % 4]] ^ this._Kd[o][i];
                                }
                                n = r.slice();
                            }
                            for (var s, a = u(16), i = 0; i < 4; i++) {
                ...
                9: [function (E, e, t) {
                    ! function (e, t) {
                        ...
                        m.isBN = function (e) {
                            ...
                            if ("be" === r) {
                                for (n = e.length - 1; t <= n; n -= 2) {
                                    i = a(e, t, n) << o, this.words[s] |= 67108863 & i, 18 <= o ? (o -= 18, this.words[s += 1] |= i >>> 26) : o += 8;
                                }
                            } else {
                            ...
                            for (var i = i / t | 0, o = e.length - r, s = o % --n, a = Math.min(o, o - s) + r, u = 0, l = r; l < a; l += n) {
                        ...
                        function o(e, t, r) {
                            ...
                            for (var o = 1; o < n; o++) {
                                for (var s, a = i >>> 26, u = 67108863 & i, l = Math.min(o, t.length - 1), h = Math.max(0, o - e.length + 1); h <= l; h++) {
                                    a += (s = (0 | e.words[o - h | 0]) * (0 | t.words[h]) + u) / 67108864 | 0, u = 67108863 & s;
                                }
                                r.words[o] = 0 | u, i = 0 | a;
                            }
                        ...
                        m.prototype.toString = function (e, t) {
                            ...
                            if (t) {
                                for (s = 0; !u.isZero(); s++) {
                                    o = u.andln(255), u.iushrn(8), a[s] = o;
                                }
                                for (; s < i; s++) {
                                    a[s] = 0;
                                }
                                ...
                                for (s = 0; !u.isZero(); s++) {
                                    o = u.andln(255), u.iushrn(8), a[i - s - 1] = o;
                                }
                            }
                            return a
                            ...
                            for (var n = this.length > e.length ? (r = this, e) : (r = e, this), i = 0, o = 0; o < n.length; o++) {
                            ...
                            for (var i = 0 < n ? (r = this, e) : (r = e, this), o = 0, s = 0; s < i.length; s++) {
                                o = (t = (0 | r.words[s]) - (0 | i.words[s]) + o) >> 26, this.words[s] = 67108863 & t;
                            }
                        ...
                        Math.imul || (s = o), m.prototype.mulTo = function (e, t) {
                            ...
                            for (var i = 0, o = 0; o < t; o++) {
                                i += 0 | e[o], r[2 * o] = 8191 & i, r[2 * o + 1] = 8191 & (i >>>= 13), i >>>= 13;
                            }
                            for (o = 2 * t; o < n; ++o) {
                                r[o] = 0;
                            }
                            ...
                            for (; o < this.length - r; o++) {
                                i = (s = (0 | this.words[o + r]) + i) >> 26, this.words[o + r] = 67108863 & s;
                            }
                            if (0 === i) {
                                return this.strip();
                            }
                            for (y(-1 === i), o = i = 0; o < this.length; o++) {
                                i = (s = -(0 | this.words[o]) + i) >> 26, this.words[o] = 67108863 & s;
                            }
                            ...
                            for (var l = a - 1; 0 <= l; l--) {
                                ...
                                for (n._ishlnsubmul(i, h, l); 0 !== n.negative;) {
                        ...
                        g.prototype._tmp = function () {
                            ...
                            y(!r.isZero());
                            for (var i = new m(1).toRed(this), o = i.redNeg(), s = this.m.subn(1).iushrn(1), a = new m(2 * (a = this.m.bitLength()) * a).toRed(this); 0 !== this.pow(a, s).cmp(o);) {
                                a.redIAdd(o);
                            }
                            for (var u = this.pow(a, r), l = this.pow(e, r.addn(1).iushrn(1)), h = this.pow(e, r), f = n; 0 !== h.cmp(i);) {
                                for (var c = h, d = 0; 0 !== c.cmp(i); d++) {
                                    c = c.redSqr();
                                }
                                y(d < f);
                ...
                13: [function (e, t, r) {
                    ...
                    function s(e, t) {
                        ...
                        for (var i = [], o = 0; o < n.length; o += r.step) {
                            for (var s = 0, a = o + r.step - 1; o <= a; a--) {
                                s = (s << 1) + n[a];
                            }
                            i.push(s);
                        }
                        for (var u = this.jpoint(null, null, null), l = this.jpoint(null, null, null), h = t; 0 < h; h--) {
                            for (o = 0; o < i.length; o++) {
                                (s = i[o]) === h ? l = l.mixedAdd(r.points[o]) : s === -h && (l = l.mixedAdd(r.points[o].neg()));
                            }
                            u = u.add(l);
                        }
                        return u.toP()
                        ...
                        for (var r = e._getNAFPoints(4), n = r.wnd, i = r.points, o = S(t, n, this._bitLength), s = this.jpoint(null, null, null), a = o.length - 1; 0 <= a; a--) {
                            for (var u = 0; 0 <= a && 0 === o[a]; a--) {
                                u++;
                            }
                            if (0 <= a && u++, s = s.dblp(u), a < 0) {
                                break;
                            }
                            var l = o[a];
                        ...
                        for (l = n - 1; 1 <= l; l -= 2) {
                            ...
                            if (1 === o[c] && 1 === o[d]) {
                                ...
                                a[c] = S(r[c], o[c], this._bitLength), a[d] = S(r[d], o[d], this._bitLength), u = Math.max(a[c].length, u), u = Math.max(a[d].length, u);
                            }
                        }
                        ...
                        for (l = u; 0 <= l; l--) {
                            for (var _ = 0; 0 <= l;) {
                                for (var M = !0, A = 0; A < n; A++) {
                                    w[A] = 0 | a[A][l], 0 !== w[A] && (M = !1);
                                }
                                if (!M) {
                                    break;
                                }
                        ...
                        if ((4 === e[0] || 6 === e[0] || 7 === e[0]) && e.length - 1 == 2 * t) {
                            return 6 === e[0] ? f(e[e.length - 1] % 2 == 0) : 7 === e[0] && f(e[e.length - 1] % 2 == 1), this.point(e.slice(1, 1 + t), e.slice(1 + t, 1 + 2 * t));
                        }
                ...
                17: [function (e, t, r) {
                    ...
                    i(a, o), (t.exports = a).prototype._getEndomorphism = function (e) {
                        ...
                        if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) {
                            return r = (e.beta ? new b(e.beta, 16) : r = (n = this._getEndoRoots(this.p))[0].cmp(n[1]) < 0 ? n[0] : n[1]).toRed(this.red), e.lambda ? t = new b(e.lambda, 16) : (n = this._getEndoRoots(this.n), 0 === this.g.mul(n[0]).x.cmp(this.g.x.redMul(r)) ? t = n[0] : (t = n[1], s(0 === this.g.mul(t).x.cmp(this.g.x.redMul(r))))), {
                                beta: r,
                                lambda: t,
                ...
                19: [function (e, t, r) {
                    ...
                    function u(e) {
                        ...
                        if (null !== (t = new p(t, n)).recoveryParam) {
                ...
                20: [function (e, t, r) {
                    ...
                    function o(e, t) {
                        ...
                        if (e.x || e.y) {
                            return "mont" === this.ec.curve.type ? i(e.x, "Need x coordinate") : "short" !== this.ec.curve.type && "edwards" !== this.ec.curve.type || i(e.x && e.y, "Need both x and y coordinate"), void(this.pub = this.ec.curve.point(e.x, e.y));
                        }
                ...
                21: [function (e, t, r) {
                    ...
                    function h(e, t) {
                        ...
                        var t = this.r.toArray(),
                            r = this.s.toArray();
                        for (128 & t[0] && (t = [0].concat(t)), 128 & r[0] && (r = [0].concat(r)), t = l(t), r = l(r); !(r[0] || 128 & r[1]);) {
                            r = r.slice(1);
                        }
                        var n = [2];
                ...
                29: [function (e, t, r) {
                    ...
                    n.inherits(o, i), (r.ripemd160 = o).blockSize = 512, o.outSize = 160, o.hmacStrength = 192, o.padLength = 64, o.prototype._update = function (e, t) {
                        for (var r, n = h = this.h[0], i = p = this.h[1], o = d = this.h[2], s = c = this.h[3], a = f = this.h[4], u = 0; u < 80; u++) {
                            var l = m(y(v(h, b(u, p, d, c), e[w[u] + t], (r = u) <= 15 ? 0 : r <= 31 ? 1518500249 : r <= 47 ? 1859775393 : r <= 63 ? 2400959708 : 2840853838), M[u]), f),
                                h = f,
                                f = c,
                                c = y(d, 10),
                                d = p,
                ...
                33: [function (e, t, r) {
                    ...
                    n.inherits(u, s), (t.exports = u).blockSize = 512, u.outSize = 256, u.hmacStrength = 192, u.padLength = 64, u.prototype._update = function (e, t) {
                        ...
                        for (; n < r.length; n++) {
                            r[n] = m(A(r[n - 2]), r[n - 7], M(r[n - 15]), r[n - 16]);
                        }
                        var i = this.h[0],
                            o = this.h[1],
                            s = this.h[2],
                        ...
                        for (p(this.k.length === r.length), n = 0; n < r.length; n++) {
                            var c = g(f, _(u), v(u, l, h), this.k[n], r[n]),
                                d = y(w(i), b(i, o, s)),
                                f = h,
                                h = l,
                                l = u,
                            ...
                            ! function () {
                                ...
                                g.prototype.update = function (e) {
                                    for (var t, r, n = "string" != typeof e, i = (e = n && e.constructor === ArrayBuffer ? new Uint8Array(e) : e).length, o = this.blocks, s = this.byteCount, a = this.blockCount, u = 0, l = this.s; u < i;) {
                                        if (this.reset) {
                                            for (this.reset = !1, o[0] = this.block, t = 1; t < a + 1; ++t) {
                                                o[t] = 0;
                                            }
                                        }
                                        if (n) {
                                            for (t = this.start; u < i && t < s; ++u) {
                                                o[t >> 2] |= e[u] << h[3 & t++];
                                            }
                                        } else {
                                            for (t = this.start; u < i && t < s; ++u) {
                                                (r = e.charCodeAt(u)) < 128 ? o[t >> 2] |= r << h[3 & t++] : (r < 2048 ? o[t >> 2] |= (192 | r >> 6) << h[3 & t++] : (r < 55296 || 57344 <= r ? o[t >> 2] |= (224 | r >> 12) << h[3 & t++] : (r = 65536 + ((1023 & r) << 10 | 1023 & e.charCodeAt(++u)), o[t >> 2] |= (240 | r >> 18) << h[3 & t++], o[t >> 2] |= (128 | r >> 12 & 63) << h[3 & t++]), o[t >> 2] |= (128 | r >> 6 & 63) << h[3 & t++]), o[t >> 2] |= (128 | 63 & r) << h[3 & t++]);
                                            }
                                        }
                                        if (s <= (this.lastByteIndex = t)) {
                                            for (this.start = t - s, this.block = o[a], t = 0; t < a; ++t) {
                                                l[t] ^= o[t];
                                            }
                                            v(l), this.reset = !0;
                                        } else {
                                    ...
                                    for (var e, t, r = this.blockCount, n = this.s, i = this.outputBlocks, o = this.extraBytes, s = 0, a = 0, u = []; a < i;) {
                                        for (s = 0; s < r && a < i; ++s, ++a) {
                                            t = n[s], u[e = a << 2] = 255 & t, u[e + 1] = t >> 8 & 255, u[e + 2] = t >> 16 & 255, u[e + 3] = t >> 24 & 255;
                                        }
                                        a % r == 0 && v(n);
                                    }
                    ...
                    ! function (C) {
                        ! function () {
                            function l(e) {
                                ...
                                function t(e) {
                                    for (var t = 0, r = e.length; 64 <= r;) {
                                        for (var n, i, o, s, a = g, u = v, l = b, h = w, f = _, c = M, d = A, p = E, y = 0; y < 16; y++) {
                                            S[y] = (255 & e[i = t + 4 * y]) << 24 | (255 & e[i + 1]) << 16 | (255 & e[i + 2]) << 8 | 255 & e[i + 3];
                                        }
                                        for (y = 16; y < 64; y++) {
                                            o = ((n = S[y - 2]) >>> 17 | n << 15) ^ (n >>> 19 | n << 13) ^ n >>> 10, n = S[y - 15], S[y] = (o + S[y - 7] | 0) + ((s = (n >>> 7 | n << 25) ^ (n >>> 18 | n << 14) ^ n >>> 3) + S[y - 16] | 0) | 0;
                                        }
                                        for (y = 0; y < 64; y++) {
                                            o = (((f >>> 6 | f << 26) ^ (f >>> 11 | f << 21) ^ (f >>> 25 | f << 7)) + (f & c ^ ~f & d) | 0) + (p + (m[y] + S[y] | 0) | 0) | 0, s = ((a >>> 2 | a << 30) ^ (a >>> 13 | a << 19) ^ (a >>> 22 | a << 10)) + (a & u ^ a & l ^ u & l) | 0, p = d, d = c, c = f, f = h + o | 0, h = l, l = u, u = a, a = o + s | 0;
                                        }
                            ...
                            function P(e, t, r, n, i) {
                                var o;
                                for (T(e, 16 * (2 * r - 1), i, 0, 16), o = 0; o < 2 * r; o++) {
                                    I(e, 16 * o, i, 16),
                                        function (e, t) {
                                            T(e, 0, t, 0, 16);
                                            for (var r = 8; 0 < r; r -= 2) {
                                ...
                                for (o = 0; o < r; o++) {
                                    T(e, t + 2 * o * 16, e, 16 * o, 16);
                                }
                                for (o = 0; o < r; o++) {
                                    T(e, t + 16 * (2 * o + 1), e, 16 * (o + r), 16);
                                }
                            }
                            ...
                            function e(i, e, o, s, a, u, l) {
                                ...
                                if (o = R(o, "N"), s = R(s, "r"), a = R(a, "p"), u = R(u, "dkLen"), 0 === o || 0 != (o & o - 1)) {
                                ...
                                if (i = Array.prototype.slice.call(i), !n(e)) {
                                ...
                                var c, d, p = new Uint32Array(64 * s),
                                    ...
                                    N = function () {
                                        if (M) {
                                            return l(new Error("cancelled"), w / b);
                                        }
                                        switch (A) {
                                            case 0:
                                            ...
                                            case 2:
                                                ...
                                                for (e = 0; e < f.length; e++) {
                                                    h.push(f[e] >> 0 & 255), h.push(f[e] >> 8 & 255), h.push(f[e] >> 16 & 255), h.push(f[e] >> 24 & 255);
                                                }
                                                var n = x(i, h, u);
                                                return l(null, 1, n)
                                        }
                ...
                45: [function (e, t, r) {
                    ...
                    }.call(this, e("_process"), "undefined" != typeof commonjsGlobal ? commonjsGlobal : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, e("timers").clearImmediate);
                }, {
                    _process: 43,
                    timers: 46
                }],
                ...
                48: [function (e, t, r) {
                    ...
                    e.v1 = function (e, t, r) {
                        ...
                        if ((r = s - d + (a - p) / 1e4) < 0 && void 0 === e.clockseq && (o = o + 1 & 16383), 1e4 <= (a = (r < 0 || d < s) && void 0 === e.nsecs ? 0 : a)) {
                                    ...
                                    switch (t[0]) {
                                        ...
                                        case "address":
                                            ...
                                            u._balances[n] && (a[n] = u._balances[n]), u.getBalance(n, "latest").then(function (e) {
                                                var t = u._balances[n];
                                                if (!t || !e.eq(t)) {
                                                    return u._balances[n] = e, u.emit(n, e), null
                                                }
                                            }).catch(function (e) {
                                                u.emit("error", e);
                                            });
                            ...
                            return c.resolveProperties({
                                ...
                                return m.poll(function () {
                                    return n.perform("getTransaction", t).then(function (e) {
                                        if (null == e) {
                                            return null == n._emitted["t:" + r] ? null : void 0;
                                        }
                                        var t = q.checkTransactionResponse(e);
                                        if (null == t.blockNumber) {
                                            t.confirmations = 0;
                                        } else if (null == t.confirmations) {
                                            return n._getFastBlockNumber().then(function (e) {
                                                e = e - t.blockNumber + 1;
                            ...
                            return c.resolveProperties({
                                ...
                                return m.poll(function () {
                                    return i.perform("getTransactionReceipt", t).then(function (e) {
                                        if (null == e) {
                                            return null == i._emitted["t:" + n] ? null : void 0;
                                        }
                                        if (null != e.blockHash) {
                                            ...
                                            if (null == r.blockNumber) {
                                                ...
                                                return i._getFastBlockNumber().then(function (e) {
                                                    e = e - r.blockNumber + 1;
                ...
                52: [function (e, t, r) {
                    ...
                    function d(e) {
                        if ("2.0" != e.jsonrpc) {
                            throw (t = new Error("invalid response")).result = JSON.stringify(e), t;
                        }
                        if (e.error) {
                        ...
                        i = (y = s.BaseProvider, i(g, y), g.prototype.perform = function (e, t) {
                            ...
                            switch (e) {
                                ...
                                case "getLogs":
                                    ...
                                    try {
                                        if (t.filter.fromBlock && (n += "&fromBlock=" + p(t.filter.fromBlock)), t.filter.toBlock && (n += "&toBlock=" + p(t.filter.toBlock)), t.filter.blockHash) {
                                            try {
                ...
                59: [function (e, t, r) {
                    ...
                    r.parseParamType = function (e) {
                        ...
                        if ("string" == typeof e) {
                            return "event " === (e = (e = (e = e.replace(/\s/g, " ")).replace(/\(/g, " (").replace(/\)/g, ") ").replace(/\s+/g, " ")).trim()).substring(0, 6) ? function (e) {
                                ...
                                if (!(e = (r = e.split(" returns "))[0].match(m))) {
                                    throw new Error("invalid signature");
                                }
                                if (t.name = e[1].trim(), !t.name.match(g)) {
                    ...
                    function ie(e, t) {
                        ...
                        r = t.type.match(p);
                        if (r) {
                            return (0 === (o = parseInt(r[2] || "256")) || 256 < o || o % 8 != 0) && l.throwError("invalid " + r[1] + " bit length", l.INVALID_ARGUMENT, {
                                arg: "param",
                                value: t
                        ...
                        if (r) {
                            return (0 === (o = parseInt(r[1])) || 32 < o) && l.throwError("invalid bytes length", l.INVALID_ARGUMENT, {
                                arg: "param",
                                value: t
                            }), new B(e, o, t.name);
                        }
                ...
                60: [function (e, t, r) {
                    ...
                    function y(e) {
                        ...
                        if ("string" != typeof e && u.throwError("invalid address", u.INVALID_ARGUMENT, {
                            ...
                            t = l(e = "0x" !== e.substring(0, 2) ? "0x" + e : e), e.match(/([A-F].*[a-f])|([a-f].*[A-F])/) && t !== e && u.throwError("bad address checksum", u.INVALID_ARGUMENT, {
                                arg: "address",
                                value: e
                            });
                    ...
                    r.getAddress = y, r.getIcapAddress = function (e) {
                        for (var t = new i.default.BN(y(e).substring(2), 16).toString(36).toUpperCase(); t.length < 30;) {
                            t = "0" + t;
                        }
                ...
                63: [function (e, t, r) {
                    ...
                    function y(e) {
                        if (u.checkNew(this, y), a.setType(this, "BigNumber"), "string" == typeof e) {
                ...
                64: [function (e, t, r) {
                    ...
                    function h(e) {
                        if (null == e && s.throwError("cannot convert null value to array", s.INVALID_ARGUMENT, {
                                arg: "value",
                                value: e
                            }), "string" != typeof (e = a(e) ? e.toHexString() : e)) {
                            return l(e) ? u(new Uint8Array(e)) : (s.throwError("invalid arrayify value", null, {
                                arg: "value",
                                value: e,
                                type: typeof e
                            }), null);
                ...
                66: [function (e, t, r) {
                    ...
                    var M = (Object.defineProperty(A.prototype, "extendedKey", {
                        ...
                        if (e & g) {
                            ...
                            r.set(c.arrayify(this.publicKey));
                        }
                    ...
                    function N(e, t) {
                        if ((e = c.arrayify(e)).length % 4 != 0 || e.length < 16 || 32 < e.length) {
                ...
                69: [function (e, t, r) {
                    ...
                    var s, a = e("./address"),
                        ...
                        e = function (e) {
                            for (var t in d.setType(this, "Description"), e) {
                    ...
                    C.prototype.parseTransaction = function (e) {
                        ...
                        for (var t in this.events) {
                            if (-1 !== t.indexOf("(")) {
                                t = this.events[t];
                                if (!t.anonymous && t.topic === e.topics[0]) {
                                    return new T({
                                        decode: t.decode,
                                        name: t.name,
                ...
                73: [function (e, t, r) {
                    ...
                    r.pbkdf2 = function (e, t, r, n, i) {
                        ...
                        for (var f = 1; f <= u; f++) {
                            ...
                            for (var d = 1; d < r; d++) {
                                for (var c = v.computeHmac(i, e, c), p = 0; p < o; p++) {
                                    a[p] ^= c[p];
                                }
                            }
                            var y = (f - 1) * o,
                ...
                77: [function (e, t, r) {
                    ...
                    function y(e, t) {
                        e = s.arrayify(e);
                        if (32 !== e.length) {
                            return 33 === e.length ? t ? s.hexlify(e) : "0x" + c().keyFromPublic(e).getPublic(!1, "hex") : 65 === e.length ? t ? "0x" + c().keyFromPublic(e).getPublic(!0, "hex") : s.hexlify(e) : (h.throwError("invalid public or private key", h.INVALID_ARGUMENT, {
                                arg: "key",
                                value: "[REDACTED]"
                            }), null);
                        }
                ...
                78: [function (e, t, r) {
                    ...
                    r.decryptCrowdsale = function (e, t) {
                        ...
                        if (!(e = d(p(r, "encseed"))) || e.length % 16 != 0) {
                            throw new Error("invalid encseed");
                        }
                        for (var r = c.pbkdf2(t, t, 2e3, 32, "sha256").slice(0, 16), t = e.slice(0, 16), e = e.slice(16), t = new w.default.ModeOfOperation.cbc(r, t), i = E.arrayify(t.decrypt(e)), i = w.default.padding.pkcs7.strip(i), o = "", s = 0; s < i.length; s++) {
                            o += String.fromCharCode(i[s]);
                        }
                        if (e = u.toUtf8Bytes(o), (e = new A.SigningKey(S.keccak256(e))).address !== n) {
                        ...
                        function l(e, t) {
                            ...
                            if (E.hexlify((o = e.slice(16, 32), S.keccak256(E.concat([o, r])))).substring(2) !== p(h, "crypto/mac").toLowerCase()) {
                            ...
                            var n = function (e, t) {
                                ...
                                i = e.slice(32, 64);
                            if (!n) {
                                return t(new Error("unsupported cipher")), null;
                            }
                            ...
                            if (e && "string" == typeof e) {
                                if ("scrypt" === e.toLowerCase()) {
                                    ...
                                    if ("hmac-sha256" === e) {
                                        ...
                                        if ("hmac-sha512" !== e) {
                                            return void i(new Error("unsupported prf"));
                                        }
                                        s = "sha512";
                                    }
                                    ...
                                    i(new Error("unsupported key-derivation function"));
                                }
                            } else {
                                i(new Error("unsupported key-derivation function"));
                            }
                        ...
                        var h = null;
                        if (32 !== (h = A.SigningKey.isSigningKey(e) ? E.arrayify(e.privateKey) : E.arrayify(e)).length) {
                        ...
                        if (u.entropy && (f = E.arrayify(u.entropy)), u.mnemonic) {
                            if (f) {
                                if (s.entropyToMnemonic(f) !== u.mnemonic) {
                                    throw new Error("entropy and mnemonic mismatch")
                                }
                            } else {
                                f = E.arrayify(s.mnemonicToEntropy(u.mnemonic, u.wordlist));
                            }
                        }
                        var c = u.path;
                        f && !c && (c = s.defaultPath);
                        var d = (d = u.client) || "ethers.js",
                            ...
                            y = null;
                        if (u.iv) {
                            if (16 !== (y = E.arrayify(u.iv)).length) {
                        ...
                        var m = null;
                        if (u.uuid) {
                            if (16 !== (m = E.arrayify(u.uuid)).length) {
                ...
                83: [function (e, t, r) {
                    ...
                    r.serialize = function (r, e) {
                        ...
                        if (t.r = l.hexZeroPad(n[7], 32), t.s = l.hexZeroPad(n[8], 32), u.bigNumberify(t.r).isZero() && u.bigNumberify(t.s).isZero()) {
                            t.chainId = t.v, t.v = 0;
                        } else {
                    ...
                    function i(e, t) {
                        ...
                        for (var r = [], n = 0; n < e.length; n++) {
                            ...
                            if (i < 128) {
                                ...
                                r.push(i >> 6 | 192), r.push(63 & i | 128);
                                ...
                                r.push(i >> 12 | 224), r.push(i >> 6 & 63 | 128), r.push(63 & i | 128);
                            }
                        }
                        return h.arrayify(r)
                    }
                                ...
                                if (n + o > e.length) {
                                    ...
                                    if (null !== a) {
                                        if (a <= s) {
                                            ...
                                            a <= 65535 ? r += String.fromCharCode(a) : (a -= 65536, r += String.fromCharCode(55296 + (a >> 10 & 1023), 56320 + (1023 & a)));
                                        }
                                    } else if (!t) {
                ...
                90: [function (e, t, r) {
                    ...
                    function l(e) {
                        if (null == u && (u = a.replace(/([A-Z])/g, " $1").toLowerCase().substring(1).split(" "), "0x3c8acc1e7b08d8e76f9fda015ef48dc8c710a73cb7e0f77b2c18a9b5a7adde60" !== s.check(e))) {
    ...
    var disperse = {
        ...
        address: {
            1: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // mainnet
            3: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // ropsten
            4: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // rinkeby
            5: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // goerli
            42: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // kovan
            56: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // bsc mainnet
            77: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // poa sokol
            99: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // poa network
            100: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // xdai chain
            137: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // matic
            163: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // lightstreams
            250: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // fantom
            ...
            1285: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // moonriver
            42220: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // celo
            1666600000: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // harmony
            60: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // gochain
            128: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // huobi
            66: '0x4c409CD87a44BA6686b12CAb0634A826de30Fe10', // okex
    ...
    function detectEthereumProvider(ref) {
        if (ref === void 0) ref = {};
        var mustBeMetaMask = ref.mustBeMetaMask;
        if (mustBeMetaMask === void 0) mustBeMetaMask = false;
    ...
    riot$1.tag2('disperse-app', '<section> <disperse-logo state="{state}" disperse="{disperse}"></disperse-logo> </section> <section if="{state === states.METAMASK_REQUIRED}"> <h2>metamask required</h2> <p>non-ethereum browser, consider installing metamask.</p> </section> <section if="{state === states.NETWORK_UNAVAILABLE}"> <h2>network not yet supported</h2> <p>let us know on telegram and we\'ll deploy the contract on this network.</p> <p>network id: {chain_id}</p> </section> <section if="{state &gt;= states.UNLOCK_METAMASK}"> <h2>connect to wallet</h2> <p if="{state == states.UNLOCK_METAMASK}"> <input type="submit" value="connect wallet" onclick="{unlock_accounts}" disabled="{opts.disabled}"> </p> <p>{wallet.status}</p> </section> <section if="{state &gt;= states.CONNECTED_TO_WALLET}"> <disperse-currency on-select="{select_currency}"></disperse-currency> <p if="{sending == &quot;ether&quot;}">you have <disperse-amount amount="{wallet.balance}" symbol="{symbol()}" decimals="{decimals()}"></disperse-amount> </p> </section> <section if="{state &gt;= states.CONNECTED_TO_WALLET &amp;&amp; sending === &quot;token&quot;}"> <disperse-token-loader on-select="{select_token}" on-error="{reset_token}"></disperse-token-loader> </section> <section show="{state &gt;= states.SELECTED_CURRENCY}"> <h2>recipients and amounts</h2> <p>enter one address and amount in {symbol()} on each line. supports any format.</p> <div class="shadow"> <textarea ref="addresses" spellcheck="false" oninput="{check_amounts}"></textarea> </div> </section> <section if="{state &gt;= states.ENTERED_AMOUNTS}"> <h2>confirm</h2> <disperse-addresses addresses="{addresses}" symbol="{symbol()}" decimals="{decimals()}" balance="{balance()}" left="{left()}" total="{total()}"></disperse-addresses> <disperse-transaction show="{sending === &quot;ether&quot;}" disabled="{left() &lt; 0}" title="disperse ether" action="{disperseEther}" message="{disperse_message()}"></disperse-transaction> </section> <div if="{state &gt;= states.ENTERED_AMOUNTS &amp;&amp; sending == &quot;token&quot;}"> <h2>allowance</h2> <p show="{token.allowance.lt(total())}">allow smart contract to transfer tokens on your behalf.</p> <p show="{token.allowance.gte(total())}">disperse contract has allowance, you can send tokens now.</p> <disperse-transaction class="{secondary: token.allowance.gte(total())}" title="{token.allowance.lt(total()) ? &quot;approve&quot; : &quot;revoke&quot;}" action="{token.allowance.lt(total()) ? approve : deny}"></disperse-transaction> <disperse-transaction show="{sending === &quot;token&quot;}" disabled="{left() &lt; 0 || token.allowance.lt(total())}" title="disperse token" action="{disperseToken}" message="{disperse_message()}"></disperse-transaction> </div>', '', '', function (opts) {
        ...
        this.disperseEther = async function () {
            var recipients = this.addresses.map(function (e) {
                return e.address;
            });
            var values = this.addresses.map(function (e) {
                return e.value;
            });
            console.log('disperseEther', recipients, values, this.total().toString());
            return this.disperse.contract.disperseEther(recipients, values, {
                value: this.total()
            })
        }.bind(this);
        ...
        this.total = function () {
            return this.addresses.reduce(function (t, v) {
                return t.add(v.value);
        ...
        this.disperse_message = function () {
            if (this.sending === 'token' && this.token.allowance.lt(this.total())) {
    ...
    riot$1.tag2('disperse-token-loader', '<h2>token address</h2> <form onsubmit="{load_token}"> <div class="flex"> <input type="text" ref="token" placeholder="0x89d24A6b4CcB1B6fAA2625fE562bDD9a23260359"> <input type="submit" value="load"> </div> <p class="{status}">{message}</p> <p if="{parent.token.balance}">you have <disperse-amount amount="{parent.token.balance}" symbol="{parent.symbol()}" decimals="{parent.decimals()}"></disperse-amount><span> ({parent.token.name})</span> </p> </form>', 'disperse-token-loader input[type="text"],[data-is="disperse-token-loader"] input[type="text"]{ flex-grow: 1; border: none; border-bottom: 2px #111 solid; padding: .7rem; background: #9796F0; margin-right: 1.4rem; } disperse-token-loader input[type="text"]:focus,[data-is="disperse-token-loader"] input[type="text"]:focus{ outline: none; }', '', function (opts) {
        var this$1 = this;
